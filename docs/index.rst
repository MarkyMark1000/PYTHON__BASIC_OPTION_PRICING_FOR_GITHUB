...
value of an option twice).   This makes the Gamma results for the Monte Carlo calculation a bit unstable,
which you will see in the graphs.   See the following discussion for more information:
